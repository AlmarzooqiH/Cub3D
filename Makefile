...
SRCS = $(SRCLOC)/main.c $(SRCLOC)/init.c $(SRCLOC)/error.c $(SRCLOC)/events.c $(SRCLOC)/clean.c $(SRCLOC)/render.c \
	   ...
	   $(SRCLOC)/color_validator.c $(SRCLOC)/dfs.c $(SRCLOC)/map_checks.c $(SRCLOC)/map_validator.c $(SRCLOC)/map_validator_utils.c $(SRCLOC)/parsing.c $(SRCLOC)/texture_validator.c $(SRCLOC)/utils.c $(SRCLOC)/utils2.c \
